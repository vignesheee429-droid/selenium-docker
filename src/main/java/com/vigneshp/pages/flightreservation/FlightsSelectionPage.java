...
public class FlightsSelectionPage extends AbstractPage{
    ...
    private List<WebElement> deparureFlightsOptions;
    ...
    public void selectFlights(){
        int random = ThreadLocalRandom.current().nextInt(0, deparureFlightsOptions.size());
        this.deparureFlightsOptions.get(random).click();
